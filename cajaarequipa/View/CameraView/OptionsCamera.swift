...
class OptionsCamera: UIView {
    ...
    func createComponents(){
        self.frame = CGRect(x: (screenSize.width-320*valuePro), y: 58*valuePro, width: 320*valuePro, height: screenSize.height-58*valuePro)

        flipButton = UIButton()
        flipButton.frame = CGRect(x: 0, y: (320-44)*valuePro, width: 44*valuePro, height: 44*valuePro)
        flipButton.setImage(#imageLiteral(resourceName: "loop"), for: .normal)
        addSubview(flipButton)
        
        flashButton = UIButton()
        flashButton.frame = CGRect(x:  (320-44)*valuePro, y: (320-44)*valuePro, width: 44*valuePro, height: 44*valuePro)
        flashButton.setImage(#imageLiteral(resourceName: "flash"), for: .normal)
        addSubview(flashButton)
        
        shotButton = UIButton()
        shotButton.frame = CGRect(x:  (screenSize.width-74*valuePro)/2, y: (320+42)*valuePro, width: 74*valuePro, height: 74*valuePro)
        shotButton.setImage(#imageLiteral(resourceName: "shutter"), for: .normal)
        addSubview(shotButton)
        
        libraryButton = UIButton()
        libraryButton.frame = CGRect(x: 0 , y: self.frame.size.height - 44*valuePro, width:  (screenSize.width)/2 , height: 44*valuePro)
        ...
        photoButton.frame = CGRect(x: (screenSize.width)/2 , y: self.frame.size.height - 44*valuePro, width:  (screenSize.width)/2 , height: 44*valuePro)

...
public var fusumaCameraRollTitle = "BIBLIOTECA"
...
public class FusumaViewController: UIViewController {
    ...
    override public func viewDidLoad() {
        ...
        menuView.backgroundColor = UIColor.init(hexString: GlobalConstants.color.blue);//fusumaBackgroundColor
        ...
        cameraButton.frame = CGRect(x: 0, y: self.view.frame.size.height, width: 0, height: 0)
        libraryButton.frame = CGRect(x: 0, y: self.view.frame.size.height, width: 0, height: 0)
        videoButton.frame = CGRect(x: 0, y: self.view.frame.size.height, width: 0, height: 0)
